                  ...
                  child: DecoratedBox(
                    ...
                    child: DefaultTabController(
                      ...
                      child: TabBar(
                        ...
                        onTap: (value) {
                          switch (value){
                            case 0: indexModel.updateFontSize(ScaleType.min);
                              break;
                            case 1: indexModel.updateFontSize(ScaleType.less);
                              break;
                            case 2: indexModel.updateFontSize(ScaleType.medium);
                              break;
                            case 3: indexModel.updateFontSize(ScaleType.more);
                              break;
                            case 4: indexModel.updateFontSize(ScaleType.max);
                              break;
                          }
            ...
            builder: (_, currentColor, child) {
              return Row(
                ...
                children: [
                  ...
                  ScalableText("主题色设置", style: TextStyle(color: judgeCurrentThemeColor(context).withValues(alpha: 0.8)))
                ]
              );
            }
          ),
              ...
              child: DecoratedBox(
                ...
                child: DefaultTabController(
                  ...
                  child: TabBar(
                    ...
                    onTap: (value) {
                      switch (value){
                        case 0: indexModel.updateThemeMode(ThemeMode.system, config: true);
                          break;
                        case 1: indexModel.updateThemeMode(ThemeMode.light, config: true);
                          break;
                        case 2: indexModel.updateThemeMode(ThemeMode.dark, config: true);
                          break;
                      }
        ...
        child: ListTile(
          ...
          title: Row(
            ...
            children: [
              ...
              ScalableText("关于", style: TextStyle(fontSize: AppFontSize.s16)),
            ],
          )
        ),
      ),
            ...
            child: ListTile(
              ...
              title: Row(
                ...
                children: [
                  ...
                  ScalableText("(Debug)测试触发工具", style: TextStyle(fontSize: AppFontSize.s16)),
                ],
              )
            ),
          ),
        ...
        child: ListTile(
          ...
          title: Row(
            ...
            children: [
              ...
              ScalableText("代理配置与连通性测试", style: TextStyle(fontSize: AppFontSize.s16)),
            ],
          )
        ),
      ),
